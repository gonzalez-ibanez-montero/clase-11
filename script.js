Papa.parse("https://raw.githubusercontent.com/MirkoGonzalez/clase-11/main/territorios-electorales.csv", {
    download: true,
    header: true,
    dynamicTyping: true,
    complete: function (respuesta) {
        ...
        link[0].onclick = function () {
            ...
            document.getElementById("contenido").innerHTML = '<table <img src="images/region-' +
                (i + 1) +
                '.jpg" class="w-100"/>class="table"><thead><tr><th class="text-center">Distrito</th><th>Comuna</th><th class="text-end">Electores</th></tr></thead><tbody></tbody><table class="table">';
            var total = 0;
